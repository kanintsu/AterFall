...
func _v10_show_character_roster() -> void:
	...
	for id in V10_CHARACTERS:
		var c:Dictionary=V10_CHARACTERS[id]; var unlocked:bool=bool(profile_unlocked_characters.has(id) or str(id)=="starter"); var rarity:String=str(c.rarity); var col:Color=V10_RARITY_COLORS.get(rarity,MUTED)
